      ...
      <section className="section content-width" style={{ marginTop: '1.5rem' }}>
        ...
        <div style={{ background: 'rgba(56,189,248,0.07)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: '0.375rem', padding: '0.6rem 0.9rem', marginBottom: '1rem', fontSize: '0.85rem' }}>
          ...
          <ul style={{ margin: '0.4rem 0 0', color: 'var(--color-text-secondary)', paddingLeft: '1.2rem' }}>
            ...
            <li><strong>Violet solid</strong> — Synchronism&apos;s real C(&#x03C1;) at &#x03B3;=2 with the framework&apos;s asserted &#x03C1;<sub>crit</sub> = 0.029&middot;V&sup2;. The disk&apos;s density is thousands of times below &#x03C1;<sub>crit</sub>, so C stays near zero and the curve sits on the baryon line. <strong>This is the 2026-07-02 audit result, rendered.</strong> <em>Scale caveat (2026-08-05):</em> that &ldquo;thousands of times below&rdquo; is <strong>conditional on A = 0.029</strong>, since &#x03C1;/&#x03C1;<sub>crit</sub> &#x221D; 1/A. At the A the framework&apos;s own stated Jeans formula yields (4.6&times;10<sup>&minus;5</sup>) the ratio is 0.91 for NGC 3198 and the curve would lift off the baryon line entirely. The 635&times; gap between the two is an unstated{' '}
            <Link href="/critical-density" style={{ color: 'var(--color-accent-blue)' }}>coarse-graining length</Link> (A &#x221D; 1/&#x2113;&sup2;; 0.029 &#x21D4; &#x2113; &#x2248; 317 pc, close to this page&apos;s own pinned h = 300 pc). This plot shows the framework at one scale choice, not at all of them.</li>
