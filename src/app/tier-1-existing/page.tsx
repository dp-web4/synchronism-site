...
const tests: Test[] = [
  {
    ...
    sameRun: {
      role: 'secondary',
      text: 'That run is this card\'s SPARC phase, so the SPARC phase is not open. Until 2026-09-14 this card read as an open $0 / 6-week proposal. TEST-05 carries the lever-magnitude adjudication of the same run.',
    },
    alert: 'Scope note (corrected 2026-09-14): TEST-01, TEST-03s and TEST-05 all test one prediction, environment-dependent RAR, and all three were answered by one SPARC run. Read them as one test, not three. The large-sample phase has never been run: the registered TEST-03 on ALFALFA-SDSS (14,585 galaxies classified cluster/field/void). This note previously assigned that sample to TEST-05, whose data line is SPARC.',
  },
  {
    id: 'TEST-02',
  ...
  },
  {
    ...
    cost: '$0',
    time: '2 months',
    prediction: 'RAR scatter shows NP2 environment dependence at the registered amplitude: Session 177 says environment explains > 20% of RAR scatter, with a kill bar of r² < 0.09. [Corrected 2026-09-14: this field read "(p = 5×10⁻⁶)". That is a result, not a prediction, and it belongs to the Hubble-type R² = 0.14 term, not to environment.]',
      ...
      <section className="section content-width" style={{ marginTop: '1.5rem' }}>
        ...
        <div className="card" style={{ borderLeft: '3px solid #ef4444', marginBottom: '1.5rem', padding: '0.75rem 1rem', fontSize: '0.85rem', color: 'var(--color-text-secondary)' }}>
          ...
          <p style={{ margin: '0 0 0.5rem 0' }}>
            ...
            <br /><br />
            <strong style={{ color: '#f59e0b' }}>&ldquo;Convention-dependent&rdquo; was asserted here on 2026-08-07
            and measured for TEST-09 only on 2026-09-18.</strong> TEST-10&apos;s convention-dependence had been
            executed (2026-07-29: 106/153 discs exceed the cap at B<sub>max</sub> = 3.17, 28/153 at 6.39).
            TEST-09&apos;s had not &mdash; it was the unrun half of the same registered sweep, and this sentence
            carried it as a claim for six weeks. Executed now: re-running TEST-09&apos;s own pipeline with the ceiling
          ...
          <p style={{ margin: 0 }}>
            ...
            data already excluded. The &ldquo;0 of 24 tests selected Synchronism, and none still unrun can select the framework as postulated&rdquo; framing stands (it read &ldquo;could select&rdquo; until 2026-09-14; the qualifier was added 2026-09-22 because TEST-26, outside the 24, can select the mean-density dark-energy reading the local-density postulate forbids); the one test
          ...
          <p style={{ margin: '0.75rem 0 0 0', paddingTop: '0.6rem', borderTop: '1px solid rgba(239,68,68,0.25)' }}>
            ...
            reading (explorer 2026-09-11; this item said it &ldquo;closes without data&rdquo; until 2026-09-14).</strong>{' '}
            ...
            <Link href="/parameter-derivations" style={{ color: '#ef4444' }}>Parameter Derivations</Link> had already
            marked disfavored on 2026-08-01. The &#x03A9;<sub>m</sub>/&#x03A9;<sub>b</sub> branch is still correct: that
            ratio is epoch-flat, so it gives no high-z test. This was never a registered prediction, so it eliminates a
            reading rather than adding a refutation, and the count stays 6. Numbers are in item 8 there.
          </p>
        </div>
        ...
        <div className="card card-highlight" style={{ marginBottom: '1.5rem' }}>
          <p style={{ color: 'var(--color-text-secondary)' }}>
            ...
            Tests 01, 03s and 05 are one environment run under three IDs. Count it as one test, filed on TEST-03s (corrected 2026-09-14 from &ldquo;on different samples&rdquo;: all three were answered on SPARC).
            TEST-02 (wide binaries, Gaia DR3) is not waiting on a test of ours &mdash; it is waiting on an external
            dispute (wording corrected 2026-09-08; &ldquo;pending&rdquo; read as if the site were waiting on its own
            run): whether Gaia DR3 wide binaries show a MOND-scale boost at ≲10⁻¹⁰ m/s² is a live 2023–2025 argument
