      ...
      <section className="card card-highlight" style={{ marginBottom: '3rem' }}>
        ...
        <div style={{ textAlign: 'center', color: 'var(--color-text-secondary)', fontSize: '0.9rem' }}>
          <p style={{ marginBottom: '0.5rem' }}>
            ...
            <strong style={{ color: 'var(--color-accent-violet)' }}>&#x03C1;<sub>crit</sub></strong> = the &ldquo;knee&rdquo;: the density where the S-curve bends from flat to steep (a reference scale, not a phase-transition point)
          </p>
