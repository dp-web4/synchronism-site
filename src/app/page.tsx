    ...
    <>
      ...
      <section style={{ marginBottom: '3rem' }}>
        ...
        <p style={{ color: 'var(--color-text-muted)', fontSize: '0.82rem', marginTop: '0.75rem' }}>
          <strong>No physics background?</strong> Use the <Link href="/why-synchronism" style={{ color: 'var(--color-accent-green, #10b981)' }}>Beginner Path</Link> (6 steps, ~30 min &mdash; the one equation does appear, but every step explains it in plain words and you can skip every &ldquo;for physicists&rdquo; box) or jump to the <Link href="/galaxy-plotter" style={{ color: 'var(--color-accent-green, #10b981)' }}>Galaxy Curve Plotter</Link>.{' '}
