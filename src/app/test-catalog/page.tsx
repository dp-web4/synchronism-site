      ...
      <section className="section content-width" style={{ marginTop: '1.5rem' }}>
        ...
        <div style={{
          ...
          <ul style={{ color: 'var(--color-text-secondary)', fontSize: '0.9rem', margin: '0 0 0.5rem', paddingLeft: '1.25rem' }}>
            ...
            <li><strong>DESI fσ₈ (TEST-04a)</strong>: post-hoc retrodiction, consistent within errors, kill criterion not triggered — <span style={{ color: '#f59e0b' }}>NON-DISCRIMINATING</span> <span style={{ color: 'var(--color-text-muted)' }}>(corrected 2026-05-25; &ldquo;sign reversed&rdquo; characterization retracted)</span></li>
